...
if __name__ == '__main__':
    ...
    data_generator_train = data_gen_new.DataGenerator(img_dir_path=IMAGES_TRAIN_PATH,
                                                      ...
                                                      arr_preprocessing_func=preprocess_input, #preprocessing for VGG19
    ...
    base_model = model.makeBaseModelVGG19(INPUT_SHAPE)
    ...
    model_filename = f"VGG19_model_{INPUT_SHAPE[0]}_{INPUT_SHAPE[1]}.h5"
